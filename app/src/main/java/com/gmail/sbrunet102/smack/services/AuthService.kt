...
import com.gmail.sbrunet102.smack.utilities.URL_CREATE_USER
import com.gmail.sbrunet102.smack.utilities.URL_LOGIN
import com.gmail.sbrunet102.smack.utilities.URL_REGISTER
    ...
    fun registerUser(
        ...
        val registerRequest =
            object : StringRequest(Method.POST, URL_REGISTER, Response.Listener { response ->
                ...
                Log.d("ERROR regsiterUser", "Could not register user: $error")
                complete(false)
            }) {
    ...
    fun loginUser(context: Context, email: String, password: String, complete: (Boolean) -> Unit) {
        ...
        val loginRequest =
            object : JsonObjectRequest(Method.POST, URL_LOGIN, null, Response.Listener { response ->
                ...
                Log.d("ERROR login", "Could not register user: $error")
                complete(false)
            }) {
                override fun getBodyContentType(): String {
                    return "application/json; charset=utf-8"
    ...
    fun createUser(
        ...
        val createRequest = object :
            JsonObjectRequest(Method.POST, URL_CREATE_USER, null, Response.Listener { response ->
                ...
                Log.d("ERROR create", "Could not add user: $error")
                complete(false)
            }) {
            override fun getBodyContentType(): String {
                return "application/json; charset=utf-8"
